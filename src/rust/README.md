...
For storage alone, use `dtlvnative = "1.1.4"`.

The crates use prebuilt native libraries downloaded from
[GitHub releases](https://github.com/datalevin/dtlvnative/releases/tag/1.1.4).
...
```toml
[dependencies]
dtlvnative = { version = "1.1.4", default-features = false, features = ["usearch"] }
```
