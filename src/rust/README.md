...
For storage alone, use `dtlvnative = "1.1.5"`.

The crates use prebuilt native libraries downloaded from
[GitHub releases](https://github.com/datalevin/dtlvnative/releases/tag/1.1.5).
...
```toml
[dependencies]
dtlvnative = { version = "1.1.5", default-features = false, features = ["usearch"] }
```
